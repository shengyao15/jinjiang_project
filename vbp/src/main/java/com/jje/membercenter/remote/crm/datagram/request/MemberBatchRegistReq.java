...
public class MemberBatchRegistReq  extends CrmRequest {
    public MemberBatchRegistReq() {
        super(CrmTransCode.BATCH_REGISTER_MEMBER);
    ...
    public static class Contact {
        ...
        private com.jje.membercenter.remote.vo.Contact.Listofpersonaladdress listofpersonaladdress;

        public com.jje.membercenter.remote.vo.Contact.Listofpersonaladdress getListofpersonaladdress() {
            return listofpersonaladdress;
        }

        public void setListofpersonaladdress(com.jje.membercenter.remote.vo.Contact.Listofpersonaladdress listofpersonaladdress) {
