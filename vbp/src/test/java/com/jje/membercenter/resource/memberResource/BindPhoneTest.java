...
public class BindPhoneTest extends DataPrepareFramework {
	...
	@Test   
	public void should_be_success_when_bind_phone() throws Exception {
		...
		InvokeResult<CRMResponseDto> result = resourceInvokeHandler.doPost("memberResource", MemberResource.class,
				"/member/bindPhone", getMemberDto(), CRMResponseDto.class);
