...
public class ListInvoiceTypesTest extends DataPrepareFramework {
	...
	@Test   
	public void should_be_success_when_list_remindQuestion_types() throws Exception {
		InvokeResult<ResultMemberDto> result = resourceInvokeHandler.doGet("memberResource", MemberResource.class,
				"/member/listRemindQuestionTypes", ResultMemberDto.class);
