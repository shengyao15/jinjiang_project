...
public class ListEduTypesTest extends DataPrepareFramework {
	...
	@Test   
	public void should_be_success_when_list_edu_types() throws Exception {
		InvokeResult<ResultMemberDto> result = resourceInvokeHandler.doGet("memberResource", MemberResource.class,
				"/member/listEduTypes", ResultMemberDto.class);
